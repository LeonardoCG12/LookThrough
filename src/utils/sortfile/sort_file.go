...
func init() {
	...
	rules := map[string][]string{
		...
		"Videos": {
			"mp4", "mkv", "avi", "mov", "wmv", "flv", "webm", "mpeg", "mpg", "m4v", "3gp", "vob", "ogv", "qt", "mts", "m2ts", "asf", "rm", "rmvb", "divx", "mxf", "rcv",
		},
		"Audio": {
		...
		"Design_3D_CAD": {
			"step", "stp", "igs", "iges", "stl", "obj", "fbx", "gcode", "blend", "skp", "3ds", "c4d", "sldprt", "sldasm", "ipt", "iam", "dwf", "sat", "max", "ma", "mb", "gltf", "glb", "ply", "prt",
		},
		"Fonts": {
